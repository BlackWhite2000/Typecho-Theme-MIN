...
<div class="row">
    ...
    <div class="col text-end">
        <figure class="mb-0 lead">
            <blockquote class="blockquote text-blue text-opacity-25">
                分页
            </blockquote>
...
<!--输出最新文章-->
<div class="grid grid-rows-3 grid-flow-col gap-4 " style="align-items: center;justify-content: center;">
    <?php while ($this->next()) : ?>
        <div class="col">
